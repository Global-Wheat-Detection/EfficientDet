...
ap.add_argument('--split_ids', type=str, default='', help='Path to (train, val) split list')
ap.add_argument('--force_resolution', type=int, default=None)
args = ap.parse_args()
...
input_size = args.force_resolution if args.force_resolution is not None else input_sizes[compound_coef]

id_path = args.split_ids
...
if __name__ == '__main__':
    ...
    coco_gt = COCO(VAL_GT)
    image_ids = load_val_ids(id_path)
